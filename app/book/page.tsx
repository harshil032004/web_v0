        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid lg:grid-cols-3 gap-12 mb-12">
            ...
            <div className="lg:col-span-1">
              <Card className="border-0 shadow-2xl hover:shadow-3xl transition-shadow duration-300 h-full bg-linear-to-br from-white to-gray-50">
                ...
                <CardContent className="space-y-4 flex flex-col justify-between h-full">
                  <div className="space-y-4">
                    <div className="flex items-start space-x-3 p-4 rounded-lg bg-green-50 border border-green-100">
                      <Shield className="h-6 w-6 text-green-600 mt-0.5 shrink-0" />
                      <div>
                    ...
                    <div className="flex items-start space-x-3 p-4 rounded-lg bg-yellow-50 border border-yellow-100">
                      <Star className="h-6 w-6 text-yellow-600 mt-0.5 shrink-0" />
                      <div>
                    ...
                    <div className="flex items-start space-x-3 p-4 rounded-lg bg-purple-50 border border-purple-100">
                      <CheckCircle className="h-6 w-6 text-purple-600 mt-0.5 shrink-0" />
                      <div>
